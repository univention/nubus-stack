...
|------------|------|---------|
| oci://artifacts.software-univention.de/nubus-dev/charts | keycloak(keycloak) | 0.5.1-pre-jtorres-fixup-upgrade-kc-25 |
...
| oci://artifacts.software-univention.de/nubus/charts | nubusUmcServer(umc-server) | 0.27.2 |
