...
* Configure root_path for UMC ([9d76204](https://git.knut.univention.de/univention/dev/nubus-for-k8s/nubus-helm/commit/9d762040933e6a6d2abfb3fc1a470278937f31f8)), closes [univention/dev/internal/team-nubus#1551](https://git.knut.univention.de/univention/dev/internal/team-nubus/issues/1551)
* **portal-assets:** Load portal-assets from LDAP directly and serve them via the portal-frontend Nginx instead of S3 ([4cf2594](https://git.knut.univention.de/univention/dev/nubus-for-k8s/nubus-helm/commit/4cf2594a84c114282cd0ac43dbd218d8bea758e2)), closes [univention/dev/internal/team-nubus#1589](https://git.knut.univention.de/univention/dev/internal/team-nubus/issues/1589)
* **portal-frontend:** Serve /favicon/ path from portal-frontend instead of umbrella chart ([e3497ef](https://git.knut.univention.de/univention/dev/nubus-for-k8s/nubus-helm/commit/e3497efdd0be54fd9ce4423270700192698e34bc)), closes [univention/dev/internal/team-nubus#1603](https://git.knut.univention.de/univention/dev/internal/team-nubus/issues/1603)
* update keycloak-bootstrap to fetch-mapped-ldap version ([7c3c13b](https://git.knut.univention.de/univention/dev/nubus-for-k8s/nubus-helm/commit/7c3c13bb6db07a38b9f1181fdb11da0c06e69c71)), closes [univention/dev/internal/team-nubus#1549](https://git.knut.univention.de/univention/dev/internal/team-nubus/issues/1549)
* update portal charts for ingress without nginx specifics ([c6de0bf](https://git.knut.univention.de/univention/dev/nubus-for-k8s/nubus-helm/commit/c6de0bf4d94de50afdfca235ff55701d1441f91b)), closes [univention/dev/internal/team-nubus#1550](https://git.knut.univention.de/univention/dev/internal/team-nubus/issues/1550)
* update stack-data to fix SSL warning ([0e6a000](https://git.knut.univention.de/univention/dev/nubus-for-k8s/nubus-helm/commit/0e6a000c4afaaef5fdb079f242b42e1164725a74)), closes [univention/dev/ucs#3367](https://git.knut.univention.de/univention/dev/ucs/issues/3367)


### Bug Fixes

* **2fa-helpdesk,notifications-api:** Version bump to fix trailing slash redirects ([e53c134](https://git.knut.univention.de/univention/dev/nubus-for-k8s/nubus-helm/commit/e53c134664143a8ba0a005ce81fb372cada1c1cd)), closes [univention/dev/internal/team-nubus#1609](https://git.knut.univention.de/univention/dev/internal/team-nubus/issues/1609)
* **2fa-helpdesk:** Respect global.ingressClassName ([472c54a](https://git.knut.univention.de/univention/dev/nubus-for-k8s/nubus-helm/commit/472c54aaa6b9be52ff853ad260d0a008622ff624)), closes [univention/dev/internal/team-nubus#1604](https://git.knut.univention.de/univention/dev/internal/team-nubus/issues/1604)
* Bump nats container images ([1bc2c53](https://git.knut.univention.de/univention/dev/nubus-for-k8s/nubus-helm/commit/1bc2c53b978ce33a15670b9a7a35540a736d7e41)), closes [univention/dev/projects/provisioning#123](https://git.knut.univention.de/univention/dev/projects/provisioning/issues/123)
* bump vul-man ([4014483](https://git.knut.univention.de/univention/dev/nubus-for-k8s/nubus-helm/commit/40144831b9a894d47651302826e24e2263629741)), closes [univention/dev/internal/team-nubus#1586](https://git.knut.univention.de/univention/dev/internal/team-nubus/issues/1586)
* **deps:** Update dependency univention/dev/nubus-for-k8s/common-ci to v1.55.2 ([ec79aee](https://git.knut.univention.de/univention/dev/nubus-for-k8s/nubus-helm/commit/ec79aeee91f17be9a0455a1606510396c4cc1544)), closes [#0](https://git.knut.univention.de/univention/dev/nubus-for-k8s/nubus-helm/issues/0)
* **deps:** Update nubus subcharts ([e5b440b](https://git.knut.univention.de/univention/dev/nubus-for-k8s/nubus-helm/commit/e5b440ba05e363330c8ac3acb1869e48c7ddfdc8)), closes [#0](https://git.knut.univention.de/univention/dev/nubus-for-k8s/nubus-helm/issues/0)
* **deps:** Update nubus subcharts to v0.94.5 ([a1a9581](https://git.knut.univention.de/univention/dev/nubus-for-k8s/nubus-helm/commit/a1a958183f44c08a072445552a30619ad53a34df)), closes [#0](https://git.knut.univention.de/univention/dev/nubus-for-k8s/nubus-helm/issues/0)
* **helm:** bump dependencies ([3102486](https://git.knut.univention.de/univention/dev/nubus-for-k8s/nubus-helm/commit/310248668922475c20e253260567d32f36ebb805)), closes [univention/dev/internal/team-horizon#6](https://git.knut.univention.de/univention/dev/internal/team-horizon/issues/6)
* **minio:** Remove anonymous minio bucket access and the corresponding ingress manifest ([2450aeb](https://git.knut.univention.de/univention/dev/nubus-for-k8s/nubus-helm/commit/2450aeb9da99b073c93fae920b8e393cea6dacbc)), closes [univention/dev/internal/team-nubus#1589](https://git.knut.univention.de/univention/dev/internal/team-nubus/issues/1589)
* **portal-assets): fix(portal-asset-loader:** Use a readonly user account for UDM in the portal-asset-loader ([ec93390](https://git.knut.univention.de/univention/dev/nubus-for-k8s/nubus-helm/commit/ec933909e1b5848cf1b65d39e9e5cc3c62198a23)), closes [univention/dev/internal/team-nubus#1589](https://git.knut.univention.de/univention/dev/internal/team-nubus/issues/1589)
* **portal-frontend:** Move ingress paths into template for ingress controller-agnostic root redirect ([601a6d5](https://git.knut.univention.de/univention/dev/nubus-for-k8s/nubus-helm/commit/601a6d5c74db9c016838cbf8ddad2a520cde52a9)), closes [univention/dev/internal/team-nubus#1603](https://git.knut.univention.de/univention/dev/internal/team-nubus/issues/1603)
* **portal-frontend:** Move ingress paths into template for ingress controller-agnostic root redirect ([bac1dab](https://git.knut.univention.de/univention/dev/nubus-for-k8s/nubus-helm/commit/bac1daba719a73bd7b84057788056af84402cd8a)), closes [univention/dev/internal/team-nubus#1603](https://git.knut.univention.de/univention/dev/internal/team-nubus/issues/1603)
* **portal-frontend:** Show all left sidebar navigation category names ([3467a81](https://git.knut.univention.de/univention/dev/nubus-for-k8s/nubus-helm/commit/3467a81529bd60924cd52ef522fa84bfe9479154)), closes [univention/dev/internal/team-nubus#1577](https://git.knut.univention.de/univention/dev/internal/team-nubus/issues/1577)
* **portal:** Guardian integration ([454c98f](https://git.knut.univention.de/univention/dev/nubus-for-k8s/nubus-helm/commit/454c98f4fd16decd3266d71ad51bdad705a60910)), closes [univention/dev/internal/team-nubus#1254](https://git.knut.univention.de/univention/dev/internal/team-nubus/issues/1254)
* Remove cert-manager dependency for SAML certificates ([5e73db0](https://git.knut.univention.de/univention/dev/nubus-for-k8s/nubus-helm/commit/5e73db0261d28bcd7edc52acc9c6ca28798e4a5b)), closes [univention/dev/internal/team-nubus#1563](https://git.knut.univention.de/univention/dev/internal/team-nubus/issues/1563)
* **udm-rest,umc:** Configure root-path ([87b74ce](https://git.knut.univention.de/univention/dev/nubus-for-k8s/nubus-helm/commit/87b74ce004238058fbbaceb14d91117237aa85ee)), closes [univention/dev/internal/team-nubus#1553](https://git.knut.univention.de/univention/dev/internal/team-nubus/issues/1553) [univention/dev/internal/team-nubus#1551](https://git.knut.univention.de/univention/dev/internal/team-nubus/issues/1551)
* **umc-server:** Add an ingress path /logout-sse to fix failing logout e2e-tests ([2fa543f](https://git.knut.univention.de/univention/dev/nubus-for-k8s/nubus-helm/commit/2fa543fe23a345eeed4137da794b1db0660fe297)), closes [univention/dev/internal/team-nubus#1603](https://git.knut.univention.de/univention/dev/internal/team-nubus/issues/1603)
* **umc-server:** Add an ingress path /logout-sse to fix failing logout e2e-tests ([179406a](https://git.knut.univention.de/univention/dev/nubus-for-k8s/nubus-helm/commit/179406a375199d1f7e23400e58b764b9e2ca678b)), closes [univention/dev/internal/team-nubus#1603](https://git.knut.univention.de/univention/dev/internal/team-nubus/issues/1603)
